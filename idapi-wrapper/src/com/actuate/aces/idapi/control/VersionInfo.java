...
public class VersionInfo {
	...
	public static final int ACTUATE_MAJOR_VERSION = 11;

	// corresponds to Actuate service pack version of libraries
	public static final int ACTUATE_MINOR_VERSION = 3;

	// corresponds to major version of this wrapper
	public static final int WRAPPER_MAJOR_VERSION = 1;

	// corresponds to minor version of this wrapper
	public static final int WRAPPER_MINOR_VERSION = 7;
